        ...
        <div class="row">
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-2">
                ...
                <div>
                  <h4 class="mb-0 fw-bold text-dark" style="font-size:1.1rem;">Editar Proveedor</h4>
                  <p class="mb-0 text-muted" style="font-size:0.78rem;">Actualizar información del proveedor</p>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="Tipo" id="SelectTipoProveedor" class="form-control @error('Tipo') is-invalid @enderror" required>
                                        ...
                                        <option value="0" {{ old('Tipo', $proveedor->Tipo) == '0' ? 'selected' : '' }}>Mercancía</option>
                                        <option value="1" {{ old('Tipo', $proveedor->Tipo) == '1' ? 'selected' : '' }}>Servicio</option>
                                    </select>
                                    @error('Tipo')
                            ...
                            <!-- Resto de campos igual que en crear... -->
                            ...
                            <div id="divBancoProveedor" style="display: {{ old('Tipo', $proveedor->Tipo) == '1' ? 'block' : 'none' }};">
                                <hr>
