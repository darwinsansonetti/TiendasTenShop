...
@section('title', 'TiendasTenShop | Proveedores de Servicios')

@php
    use App\Helpers\FileHelper;
    
    // 🔥 SOLO CAMBIO DE COLORES - Naranja para Servicios
        ...
        <div class="row">
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-2">
                ...
                <div>
                  <h4 class="mb-0 fw-bold text-dark" style="font-size:1.1rem;">Proveedores de Servicios</h4>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Proveedores de Servicios</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="app-content">
    <div class="container-fluid">
        ...
        {{-- ================================================ --}}
        @if($proveedoresServicios && count($proveedoresServicios) > 0)
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 d-flex align-items-center gap-2">
                        ...
                        <span class="badge rounded-pill"
                            ...
                            {{ count($proveedoresServicios) }}
                        </span>
                        <a href="{{ route('cpanel.proveedores.servicios.crear') }}"
                                ...
                                <tr style="border-bottom:1px solid #f1f5f9;">
                                    ...
                                    <td class="text-center" data-order="{{ $telefono }}">
                                        @if($telefono)
                                            <code class="px-2 py-1 rounded-2"
                                                  style="background:#f1f5f9;color:{{ $primaryColor }};font-size:0.8rem;">{{ $telefono }}</code>
                                        @else
                                    ...
                                    <td class="pe-4 text-center">
                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                            <a href="{{ route('cpanel.proveedores.servicios.detalle', $proveedor->ProveedorId) }}"
                                            ...
                                            <a href="{{ route('cpanel.proveedores.servicios.editar', $proveedor->ProveedorId) }}"
                                               class="btn btn-sm rounded-2 d-flex align-items-center justify-content-center"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <small class="text-muted">
                            ...
                            Total: <strong>{{ count($proveedoresServicios) }}</strong> proveedor(es)
                        </small>
                    </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4" style="font-size:0.9rem;">
                    No se encontraron proveedores de servicios activos en el sistema.
                </p>
...
<script>
    ...
    function pdfTablaProveedores() {
        ...
        doc.text('Listado de Proveedores de Servicios', 14, 15);
        ...
        doc.save(`Proveedores_Servicios_${new Date().toISOString().slice(0,10)}.pdf`);
    }
    ...
    function exportarExcelProveedores() {
        ...
        XLSX.writeFile(wb, `Proveedores_Servicios_${new Date().toISOString().slice(0,10)}.xlsx`);
    }
