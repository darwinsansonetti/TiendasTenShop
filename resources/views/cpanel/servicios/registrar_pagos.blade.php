            ...
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-2">
                ...
                <div>
                  ...
                  <p class="mb-0 text-muted" style="font-size:0.78rem;">Gestión de proveedores de servicios</p>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card-header border-0 py-3" style="background:{{ $hdrBg }};">
                <div class="d-flex align-items-center justify-content-between">
                    <h6 class="mb-0 fw-bold text-white">
                        ...
                        @if($modo == 'pagos') Proveedores de Servicios @else Proveedores de Facturas @endif
                            ...
                            @foreach($proveedoresServicios as $proveedor)
                                ...
                                <tr style="border-bottom:1px solid #f1f5f9;">
                                    ...
                                    <td class="pe-4 py-3 text-center">
                                        @if($modo == 'pagos')
                                            <a href="{{ route('cpanel.proveedores.servicios.pagar', $proveedor->ProveedorId) }}"
                                        ...
                                        @else
                                            <a href="{{ route('cpanel.proveedores.servicios.nueva.factura', $proveedor->ProveedorId) }}"
                                               class="btn btn-sm rounded-2 d-inline-flex align-items-center justify-content-center"
            ...
            <div class="card-footer border-0 py-2 px-4" style="background:#f8fafc;">
                <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted">
                        ...
                        {{ count($proveedoresServicios) }} proveedor{{ count($proveedoresServicios) != 1 ? 'es' : '' }} registrado{{ count($proveedoresServicios) != 1 ? 's' : '' }}
                    </small>
                    <small class="text-muted">
