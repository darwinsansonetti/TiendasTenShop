        ...
        <div class="card card-success card-outline mb-4">
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <div class="border rounded p-3 text-center metric-card">
                            <small class="text-muted">Diferencia (No incluye $)</small>
                            <h4 class="mb-0 
                            ...
                            @foreach($cierreDiario as $item)
                                <tr id="fila-{{ $item->CierreDiarioId }}" class="align-middle">
                                    ...
                                    <td class="text-center fw-bold text-success">
                                        {{ number_format(
                                            ((float)$item->EfectivoBs + (float)$item->PagoMovilBs + (float)$item->TransferenciaBs + (float)$item->PuntoDeVentaBs) - (float)$item->EgresoBs,
                                            2, ',', '.'
                                        ) }} Bs
                                    </td>
