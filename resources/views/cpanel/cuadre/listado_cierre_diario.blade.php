    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            <h4 class="mb-0 fw-bold text-dark" style="font-size:1.1rem;">Cierres Diarios</h4>
            <p class="mb-0 text-muted" style="font-size:0.78rem;">Pendientes de registro</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
          ...
          <li class="breadcrumb-item active" aria-current="page">Cierres Pendientes</li>
        </ol>
      </div>
    </div>
    <!--end::Row-->
