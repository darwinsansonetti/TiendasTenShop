...
@php
    ...
    $hdrIcon = 'pencil';
    $hdrTitle = 'Editar Banco';
    $hdrSubtitle = 'Modificar la entidad bancaria';
@endphp
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header border-0 py-3" style="background:{{ $hdrBg }};">
                <h6 class="mb-0 fw-bold text-white">
                    <i class="bi bi-pencil me-2"></i>Editar Banco
                </h6>
            </div>
            <div class="card-body">
                <form action="{{ route('cpanel.bancos.actualizar', $banco->ID) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="es_activo" id="es_activo" class="form-select @error('es_activo') is-invalid @enderror">
                                <option value="1" {{ old('es_activo', $banco->EsActivo) == 1 ? 'selected' : '' }}>Activo</option>
                                <option value="0" {{ old('es_activo', $banco->EsActivo) == 0 ? 'selected' : '' }}>Inactivo</option>
                            </select>
                            @error('es_activo')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-12">
                            <label class="form-label fw-semibold">
                                <i class="bi bi-image me-1" style="color:#3b82f6;"></i>Logo Actual
                            </label>
                            <div class="mb-2">
                        ...
                        <div class="col-md-12">
                            <label for="logo" class="form-label fw-semibold">
                                <i class="bi bi-upload me-1" style="color:#3b82f6;"></i>Cambiar Logo
                            </label>
                            <div class="mb-3">
                                ...
                                <div>
                                    <label for="logo" class="btn btn-outline-primary btn-sm">
                                        <i class="bi bi-upload me-1"></i>Seleccionar nuevo logo
                                    </label>
                                    <input type="file" 
                                           class="d-none" 
                                           id="logo" 
                    ...
                    <div class="mt-4 pt-2 d-flex gap-2" style="border-top:1px solid #f1f5f9;">
                        <button type="submit" class="btn px-4 fw-semibold text-white" style="background:{{ $hdrBg }};border:none;">
                            <i class="bi bi-save me-1"></i> Actualizar Banco
                        </button>
